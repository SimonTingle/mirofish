...
Manages parallel simulations on both Twitter and Reddit platforms
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Args:
            ...
            document_text: Raw document content (used for LLM context understanding)
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No matching entities found. Please verify the knowledge graph was built correctly."
                self._save_simulation_state(state)
                return state
            ...
            # ========== Phase 3: LLM-based intelligent simulation config generation ==========
            if progress_callback:
                progress_callback(
                    "generating_config", 0,
